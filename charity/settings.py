...
SECRET_KEY = 'django-insecure-+b)u!i^#o)-z)m(g=%wi0b9639-qbsk7^+uac0x_o!k20dc345'
...
# e4cb2d486ca67ffc90e39536f166104bc128bf71
...
# Cache configuration (using default cache)
CACHES = {
    'default': {
